    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Thumbnail / cover image for the project (optional)', null=True, upload_to='projects/')),
                ('repo_owner', models.CharField(max_length=120)),
                ('repo_name', models.CharField(blank=True, max_length=120)),
